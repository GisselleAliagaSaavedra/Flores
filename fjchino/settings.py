"""
Django settings for fjchino project.
...
SECRET_KEY = 'django-insecure-t9g3m*+&b79jro#_au0%-e#$1_@wk$pq*6q7mahhqt@gy(aey='
...
WSGI_APPLICATION = 'fjchino.wsgi.application'
